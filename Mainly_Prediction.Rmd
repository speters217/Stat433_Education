...
# Train vs Test
set.seed(1000)
train <- state_gcs_mini[1:35, -c(1,2)]
y_test <- state_gcs_mini[36:51,]$gcs_mn_avg_mth_ol
test <- state_gcs_mini[36:51, 4:28]

# Building Model
pcr_model <- pcr(gcs_mn_avg_mth_ol~., data = train, scale =TRUE, validation = "CV")
summary(pcr_model)
...
pcr_pred2 <- predict(pcr_model, train[,2:26], ncomp = 8)
