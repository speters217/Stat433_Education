...
#autoplot(prcomp(data = princ_model_rot, scale=TRUE), label = FALSE, loadings.label = TRUE)

#ggfortify::ggbiplot(plot.data = princ_model_rot)
...
likely contributes towards HI's more average value.